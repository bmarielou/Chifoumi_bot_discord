...
export class GameEngine {
  ...
  public constructor(channelId: string, ownerId: string) {
  ...
  public challenge(challengerId: string) {
  ...
  public assassinate(playerId: string, targetId: string) {
  ...
  public blockAssassination(playerId: string) {
  ...
  public steal(playerId: string, targetId: string) {
  ...
  public blockSteal(playerId: string) {
      const player = this.players.find(p => p.id === playerId);
  ...
  public exchange(playerId: string) {
      const player = this.players.find(p => p.id === playerId);
      if (!player) throw new Error("Joueur introuvable.");
